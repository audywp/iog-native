  ...
  constructor(props) {
    ...
    this.setVerification = () => {
      ...
      if (this.props.data.data.success === true) {
        this.setState({
          getCode: this.state.getCode = this.props.data.data.code.verification_code
        })
...
export default connect(mapStateToProps, {setVerification}) (ForgotPasword);